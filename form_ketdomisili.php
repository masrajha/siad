                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            <div class="section-headline white-headline text-center">
                                <h3>Form Surat Keterangan Domisili</h3>
                            </div>
                            <ul>
                            ...
                            <div class="row">
                                <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan Surat Keterangan Domisili berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian.</div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_ketdomisili.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Surat Keterangan Domisili</h3>
