...
<?php
  ...
  $sql = mysqli_query($connect,"select * from tbl_ketsudahmenikah inner join tbl_rw on tbl_ketsudahmenikah.id_rw=tbl_rw.id_rw inner join tbl_rt on tbl_ketsudahmenikah.id_rt=tbl_rt.id_rt where id='$id'");
...
<h4 style="font-size:18px;text-align:center;font-family:times;margin-bottom: 1px"><u>SURAT KETERANGAN SUDAH MENIKAH</u></h4>
...
<p style="margin-left:30px;font-family:times">Bahwa pada tahun bertempat di Desa Banggai Kecamatan Duruka Kab.Muna telah menikah syah secara agama Islam dengan seorang Perempuan ;</p>
<table>
  <tbody>
   <tr>
      <td>Nama</td>
      <td>:</td>
      <td><?php echo $dt['nama_perempuan'];?></td>
    </tr>
    <tr>
      <td>Tempat, Tanggal Lahir</td>
      <td>:</td>
      <td><?php echo $dt['tempat_lahirperempuan'].",".$dt['tgl_lahirperempuan'];?></td>
    </tr>
    
    <tr>
      <td>Alamat</td>
      <td>:</td>
      <td><?php echo $dt['alamat_perempuan'];?></td>
    </tr>
     <tr>
      <td>Agama</td>
      <td>:</td>
      <td><?php echo $dt['agamaperempuan'];?></td>
    </tr>
     <tr>
      <td>Pekerjaan</td>
      <td>:</td>
      <td><?php echo $dt['pekerjaanperempuan'];?></td>
    </tr>
  </tbody>
</table>
