...
<?php
  $id = $_GET['id'];
  $sql = mysqli_query($connect,"select * from tbl_kettidakmampu inner join tbl_rw on tbl_kettidakmampu.id_rw=tbl_rw.id_rw inner join tbl_rt on tbl_kettidakmampu.id_rt=tbl_rt.id_rt where id='$id'");
...
<h4 style="font-size:18px;text-align:center;font-family:times;margin-bottom: 1px"><u>SURAT KETERANGAN TIDAK MAMPU</u></h4>
...
<p style="margin-left:30px;font-family:times;font-size:16px">Adalah benar nama tersebut diatas adalah warga Desa Fajar Baru Kecamatan Pagelaran Utara Kabupaten Pringsewu yang sampai dengan surat keterangan ini dikeluarkan, yang bersangkutan dikategorikan sebagai Keluarga Tidak Mampu / Keluarga Pra Sejahtera.</p>
