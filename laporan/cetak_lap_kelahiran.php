...
<?php
  ...
  $sql = mysqli_query($connect,"select * from tbl_kelahiran inner join tbl_rw on tbl_kelahiran.id_rw=tbl_rw.id_rw inner join tbl_rt on tbl_kelahiran.id_rt=tbl_rt.id_rt where id_kelahiran='$id'");
...
<h4 style="font-size:18px;text-align:center;font-family:times;margin-bottom: 1px"><u>SURAT KETERANGAN KELAHIRAN</u></h4>
...
<p style="margin-left:30px;font-family:times">Adalah Anak dari :</p>
<table>
  <tbody>
    <tr>
      <td style="width: 85px">Nama Ayah</td>
      <td>:</td>
      <td><?php echo $dt['nm_ayah'];?></td>
    </tr>
     <tr>
      <td>Nama Ibu</td>
      <td>:</td>
      <td><?php echo $dt['nm_ibu'];?></td>
    </tr>
    <tr>
      <td>Anak Ke</td>
      <td>:</td>
...
<p style="margin-left:30px;font-family:timesfont-size:16px">Demikian surat keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan dengan seperlunya.</p>
