...
<?php
  ...
  $sql = mysqli_query($connect,"select * from tbl_form_kk inner join tbl_rw on tbl_form_kk.id_rw=tbl_rw.id_rw inner join tbl_rt on tbl_form_kk.id_rt=tbl_rt.id_rt where id_form_kk='$id'");
...
<h4 style="font-size:18px;text-align:center;font-family:times;margin-bottom: 1px"><u>SURAT PENGANTAR KK</u></h4>
...
<table border="0"   style="width:100%;border:1px solid #000" >
  <tbody>
    ...
    <tr>
      ...
      <td>:</td>
      <td>Pengantar surat pembuatan Kartu Keluarga</td>
    </tr>
  </tbody>
</table>
<p style="margin-left:30px;font-family:times;font-size:16px">Orang tersebut diatas memang benar adalah warga RT.<?php echo $dt['nama_rt'];?>/ RW. <?php echo $dt['nama_rw'];?>
 Desa Fajar Baru Kecamatan Pagelaran Utara Kabupaten Pesawaran, Surat Pengantar ini dibuat guna melengkapi syarat pembuatan atau pengurusan KK ( Kartu Keluarga).
</p>
