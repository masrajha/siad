                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            ...
                            <ul>
                                ...
                                <li>Keterangan sudah Menikah</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                  <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan Keterangan Sudah Menikah berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian. </div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_ketsudahmenikah.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Keterangan Sudah Menikah</h3>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Nama</label>
                                        <input type="text" class="email form-control" name="nama" id="nama" placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="pekerjaan" class="form-control" name="pekerjaan" placeholder="Pekerjaan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Nama Laki/Perempuan</label>
                                        <input type="text" class="email form-control" name="namaperempuan"  placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Tempat Lahir Laki/Perempuan</label>
                                        <input type="text" id="name" class="form-control" name="tempat_lahirperempuan" placeholder="Tempat Lahir" required data-error="NIK Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Tanggal Lahir</label>
                                        <input type="date" class="email form-control" name="tgl_lahirperempuan"  placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong" style="border-radius: 0;margin-bottom: 20px;height: 46px;">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Agama</label>
                                        <select class="form-control" name="agamaperempuan" style="border-radius: 0;margin-bottom: 20px;height: 46px;">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Pekerjaan</label>
                                        <input type="text" id="name" class="form-control" name="pekerjaanperempuan" placeholder="Pekerjaan" required data-error="NIK Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label>Alamat Laki/Perempuan</label>
                                        <textarea id="message" rows="3" placeholder="Alamat" name="alamatperempuan" class="form-control" required data-error="Alamat  Tidak Boleh Kosong"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
