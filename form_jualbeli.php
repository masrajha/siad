                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            ...
                            <ul>
                                ...
                                <li>Surat Keterangan Jual Beli</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan surat jual beli berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian. </div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_jualbeli.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Keterangan Jual Beli</h3>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label>Alamat</label>
                                        <textarea id="alamat" rows="3" placeholder="Alamat" name="alamat1" class="form-control" required data-error="Alamat  Tidak Boleh Kosong"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label>Hari</label>
                                        <input type="text" class="email form-control" name="hari" placeholder="Hari" required data-error="Hari Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label>Tanggal</label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label>Bulan</label>
                                        <input type="text" class="email form-control" name="bulan"  placeholder="Bulan" required data-error="Umur Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label>Tahun</label>
                                        <input type="text" class="email form-control" name="tahun"  placeholder="Tahun" required data-error="Tahun Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label>Dijual</label>
                                        <input type="text" class="email form-control" name="dijual"  placeholder="Barang Yang Dijual" required data-error="Dijual Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label>Nominal</label>
                                        <input type="text" id="pekerjaan" class="form-control" name="nominal" placeholder="Nominal Jual Beli" required data-error="NIK Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                     <h5 style="margin-left: 10px">Batas-Batas</h5>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Sebelah Timur</label>
                                        <input type="text" class="email form-control" name="timur" placeholder="Batas Timur" required data-error="Batas Timur Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Sebelah Barat</label>
                                        <input type="text" class="email form-control" name="barat"  placeholder="Sebelah Barat" required data-error="Barat Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Sebelah Selatan</label>
                                        <input type="text" id="pekerjaan" class="form-control" name="selatan" placeholder="Sebelah Seletan" required data-error="Selatan Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Sebelah Utara</label>
                                        <input type="text" id="pekerjaan" class="form-control" name="utara" placeholder="Sebelah Utara" required data-error="NIK Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
