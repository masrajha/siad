                            ...
                            <div class="row">
                                <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan Surat Pengantar KK berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian. </div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_pengajuankk.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Surat Pengantar KK</h3>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Nama</label>
                                        <input type="text" class="email form-control" name="nama_kk" id="nama"  placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                       ...
                                       <input type="text" class="form-control" name="pendidikan" id="pendidikan" placeholder="Pendidikan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Status Pernikahan</label>
                                       <input type="text" class="form-control" name="status_pernikahan" id="status_pernikahan" placeholder="Status Pernikahan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>RW</label>
