...
<div class="content-wrapper">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover" id="dataTables-example17">
              <thead>
                  <tr>
                      <th>No</th>
											<th>NIK</th>
              ...
              <tbody>
                  ...
                  if($_SESSION['level']=="admin"){
                    ...
                    $q=mysqli_query($connect, "select * from tbl_pengantarnikah");
                  }else{
                    $rt = $_SESSION['rt'];
                    $q=mysqli_query($connect, "select * from tbl_pengantarnikah where id_rt='$rt'");
                  }
                  ...
                  <tr >
                      ...
                      <td >
                        ...
                        if($data['verif_rt']=="N" && $_SESSION['level']!='admin'){
                         ?>
                        <a href="aksi/verifikasi_menikah.php?id=<?php echo $data['id']; ?>&ket=rt" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      }else if($data['verif_admin']=="N" && $_SESSION['level']=='admin'){
                         ?>
                        <a href="aksi/verifikasi_menikah.php?id=<?php echo $data['id']; ?>&ket=admin" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      } ?>
                      </td>
