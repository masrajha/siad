          ...
          <table class="table table-striped table-bordered table-hover" id="dataTables-example25">
              <thead>
                  <tr>
                      ...
                      <th>Tanggal Lahir Laki/Perempuan</th>
                      <th>Tempat Lahir Laki/Perempuan</th>
                      <th>Agama Laki/Perempuan</th>
                      <th>Pekerjaan Laki/Perempuan</th>
                      <th>Status</th>
											<th>Tgl Pengajuan</th>
											<th>Opsi</th>
              ...
              <tbody>
                  ...
                  if($_SESSION['level']=="admin" || $_SESSION['level']=="lurah"){
                    ...
                    $q=mysqli_query($connect, "select * from tbl_ketsudahmenikah");
                  }else{
                    $rt = $_SESSION['rt'];
                    $q=mysqli_query($connect, "select * from tbl_ketsudahmenikah where id_rt='$rt'");
                  }
                  ...
                  <tr >
                      ...
                      <td><?php echo $data['nama_perempuan']; ?></td>
                      <td><?php echo $data['tgl_lahirperempuan']; ?></td>
                      <td><?php echo $data['tempat_lahirperempuan']; ?></td>
                      <td><?php echo $data['agamaperempuan']; ?></td>
                      <td><?php echo $data['pekerjaanperempuan']; ?></td>
                      <td><?php
                      ...
                      <?php
                         if($_SESSION['level']=='admin'){
                      ?>
                       <a href="aksi/delete_sudahnikah.php?id=<?php echo $data['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                        <?php
                      }
                        if($data['verif_rt']=="N" && $_SESSION['level']!='admin'){
                         ?>
                        <a href="aksi/verifikasi_ketsudahnikah.php?id=<?php echo $data['id']; ?>&ket=rt" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      }else if($data['verif_admin']=="N" && $_SESSION['level']=='admin'){
                         ?>
                        <a href="aksi/verifikasi_ketsudahnikah.php?id=<?php echo $data['id']; ?>&ket=admin" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      }else if($data['verif_lurah']=="N" && $data['verif_admin']=="Y" && $_SESSION['level']=='lurah'){
                         ?>
                        <a href="aksi/verifikasi_ketsudahnikah.php?id=<?php echo $data['id']; ?>&ket=lurah" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      } ?>
                      </td>
