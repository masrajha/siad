        ...
        <div class="panel panel-primary">
			...
			?>
                <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example22">
                                    <thead>
                                        <tr>
                                            <th>No</th>
											<th>NIK</th>
                      ...
                      <td><?php
                       ...
                       ?></td>
                                            ...
                                            <td >
                                              ...
                                              if($data['verif_rt']=="N"){
                                               ?>
                                              <a href="aksi/verifikasi_ktp_rt.php?id_formktp=<?php echo $data['id_form_ktp']; ?>" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                                              <?php
                                            } ?>											</td>
