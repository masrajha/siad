    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                View Keterangan Tidak Mampu <a href="laporan_kematian.php" style="float:right"><button class="btn btn-info"><i class="fa fa-print"></i> </button></a>
            </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover" id="dataTables-example14">
              <thead>
                  <tr>
                      <th>No</th>
											<th>NIK</th>
              ...
              <tbody>
                  ...
                  $q=mysqli_query($connect, "select * from tbl_kettidakmampu");
                  }else if($_SESSION['level']=="lurah"){
                  $q=mysqli_query($connect, "select * from tbl_kettidakmampu");
                  }else{
                     $rt = $_SESSION['rt'];
                  $q=mysqli_query($connect, "select * from tbl_kettidakmampu where id_rt='$rt'");
                  }
                    ...
                    <tr >
                      ...
                      <?php
                         if($_SESSION['level']=='admin'){
                      ?>
                        <a href="aksi/delete_tidakmampu.php?id=<?php echo $data['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                        <?php
                      }
                        if($data['verif_rt']=="N" && $_SESSION['level']!='admin'){
                         ?>
                        <a href="aksi/verifikasi_tidakmampu.php?id=<?php echo $data['id']; ?>&ket=rt" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      }else if($data['verif_admin']=="N" && $_SESSION['level']=='admin'){
                         ?>
                        <a href="aksi/verifikasi_tidakmampu.php?id=<?php echo $data['id']; ?>&ket=admin" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      }else if($data['verif_lurah']=="N" && $data['verif_admin']=="Y" && $_SESSION['level']=='lurah'){
                         ?>
                        <a href="aksi/verifikasi_tidakmampu.php?id=<?php echo $data['id']; ?>&ket=lurah" class="btn btn-info" title="Verifikasi"><i class="fa fa-sign-out"></i></a>
                        <?php
                      } ?>
											</td>
