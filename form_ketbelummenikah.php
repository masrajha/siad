                            ...
                            <div class="row">
                                  <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan Keterangan Belum Menikah berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian. </div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_ketbelumnikah.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Keterangan Belum Menikah</h3>
