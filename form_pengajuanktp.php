                            ...
                            <div class="row">
                                <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengaujuan Surat Pengantar KTP berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di pencarain surat pada menu surat. </div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_pengajuanktp.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Surat Pengantar KTP</h3>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Nama</label>
                                        <input type="text" class="email form-control" name="nama" id="nama"  placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="tempat_lahir" class="form-control" name="tempat_lahir" placeholder="Tempat Lahir" required data-error="NIK Tidak Boleh Kosong">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Tanggal Lahir</label>
                                        <input type="date" class="email form-control" id="tgl_lahir" name="tgl_lahir"  placeholder="Nama" required data-error="Nama Pemilik Tidak Boleh Kosong" style="border-radius: 0;margin-bottom: 20px;height: 46px;">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Agama</label>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="golongan_darah" class="form-control" name="golongan_darah" placeholder="Golongan Darah" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Kebangsaan</label>
                                       <input type="text" class="form-control" name="kebangsaan" id="kebangsaan" placeholder="Kebangsaan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="pendidikan" class="form-control" name="pendidikan" placeholder="Pendidikan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Status Perkwaninan</label>
                                        <input type="text" id="status_pernikahan" class="form-control" name="status_pernikahan" placeholder="Status Pernikahan" required data-error="NIK Tidak Boleh Kosong" readonly>
                                    </div>
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>RW</label>
