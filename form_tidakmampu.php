                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            <div class="section-headline white-headline text-center">
                                <h3>Form Keterangan Tidak Mampu</h3>
                            </div>
                            <ul>
                            ...
                            <div class="row">
                                <?php
                                    if(!empty($_GET['pesan']) && $_GET['pesan']=="sukses"){
                                        ...
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Pengajuan Keterangan Tidak Mampu berhasil disimpan. Silahkan tunggu 3-4 Hari dan silahkan cek di menu pencarian.</div>';
                                ...
                                ?>
                                <form  method="POST" action="aksi/simpan_tdkmampu.php" class="contact-form">
                                    <h3 style="margin-left: 10px">Form Keterangan Tidak Mampu</h3>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>RW</label>
										<input type="text" class="form-control"  id="id_rw" readonly>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>RT</label>
										<input type="text" class="form-control"  id="id_rt" readonly>
